...
public class UC01CadastrarEmpresa { // $codepro.audit.disable
	...
	@Test(expected = IllegalArgumentException.class)
	public void CT01UC01A31Cadastra_empresa_cnpj_invalido() {
		empresa.setCnpj("11111111111111");
		assertEquals(1, empresaDAO.adiciona(empresa));
	}

	@Test(expected = IllegalArgumentException.class)
	public void CT01UC01A4Nome_invalido() {
		empresa.setNomeDaEmpresa("");
	}

	@Test(expected = IllegalArgumentException.class)
	public void CT01UC01A5Fantasia_invalido() {
		empresa.setNomeFantasia("");

	}
	
	@Test(expected = IllegalArgumentException.class)
	public void CT01UC01A6Endereco_invalido() {
		empresa.setEndereco("");	

	}
	
	@Test(expected = IllegalArgumentException.class)
	public void CT01UC01A7Telefone_invalido() {
		empresa.setTelefone("");
	}
